...
user in an INI file next to MinFFSPortable.exe called MinFFSPortable.ini.
...
copy AppNamePortable.ini from this directory to MinFFSPortable.ini next to
MinFFSPortable.exe. The options in the INI file are as follows:
